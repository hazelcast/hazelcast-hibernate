...
public class TimestampsRegionCacheTest {
    ...
    public void shouldUpdateTimestampAfterPreInvalidationMessage_issue_33() {
        ...
        Message<Object> preInvalidate = new Message<Object>("topicName", new Timestamp("QuerySpace",
        ...
        Message<Object> invalidate = new Message<Object>("topicName", new Timestamp("QuerySpace",
        ...
        // Different updates for cache can be performed here hence not testing a certain value but instead a predicate.
